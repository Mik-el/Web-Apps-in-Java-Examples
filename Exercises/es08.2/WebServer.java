...
// Implementazione sequenzale di un Server Web
public class WebServer {
	...
	public void start() throws IOException {
		...
		// Per elaborare in loop le richieste http
		while (true) {
			// si crea una socket server che Accetta richieste di connessione
			Socket connectionSocket = welcomeSocket.accept();
			// ProtocolHandler è un oggetto per elaborare un messaggio di richiesta HTTP
...
class HttpHandler implements ProtocolHandler {
  ...
  public void handle() throws IOException {
    ...
    if (fileName.equals(File.separator)) fileName = File.separator +"hello.html";
