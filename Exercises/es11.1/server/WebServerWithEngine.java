    ...
    try {
      ...
      if (resource.exists()) {
		...
		engine.invokeService(resource, req, res);
            } catch (ClassNotFoundException e) { System.err.println("La risorsa richiesta non e' disponibile"); throw new ServerException();
            } catch (IllegalAccessException e) { System.err.println("La risorsa non e' accessibile"); throw new ServerException();
            } catch (InstantiationException e) { System.err.println("La classe non e' istanziabile"); throw new ServerException(); 
